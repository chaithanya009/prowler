...
class ProwlerArgumentParser:
    ...
    def __init__(self):
        ...
        self.parser = argparse.ArgumentParser(
            ...
            usage="prowler [-h] [--version] {aws,azure,gcp,kubernetes,m365,github,googleworkspace,nhn,mongodbatlas,oraclecloud,alibabacloud,cloudflare,openstack,vercel,okta,dashboard,iac,image,llm} ...",
            epilog="""
Available Cloud Providers:
  {aws,azure,gcp,kubernetes,m365,github,googleworkspace,iac,llm,image,nhn,mongodbatlas,oraclecloud,alibabacloud,cloudflare,openstack,vercel,okta}
    aws                 AWS Provider
